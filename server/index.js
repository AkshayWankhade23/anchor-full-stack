...
app.post("/register", async (req, res) => {
  try {
    ...
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "akshaywankhade664@gmail.com", // Your Gmail email address
        pass: "uaot cild zsdr jqhb", // Your Gmail password or an application-specific password
      },
    });

    const mailOptions = {
      from: "akshaywankhade664@gmail.com",
      to: email,
