...
const Signup = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://anchor-full-stack.onrender.com/register', { email });
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://anchor-full-stack.onrender.com/verify-otp', { email, otp });
